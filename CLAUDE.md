...
- **Vault location**: Resolved from `OBSIDIAN_VAULT` env var at runtime; not stored in this repo
...
- **Vault path comes from env**: `OBSIDIAN_VAULT`. Skills must fail loudly if unset, not invent a default.
